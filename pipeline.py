...
def normalise_nt_probs(connectome):
    ...
    connectome = connectome.dropna(subset=["gaba", "ach", "other"]) # Drop NaNs
    print("Neurotransmitter probabilities normalised")
    return connectome.persist()
